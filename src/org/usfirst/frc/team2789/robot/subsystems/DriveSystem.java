...
public class DriveSystem extends Subsystem {
	...
	public DriveSystem() {
		...
		this.m_talonBL = new Talon(RobotMap.TALON_DRIVE_BL);
		this.m_talonBR = new Talon(RobotMap.TALON_DRIVE_BR);
		this.m_talonFL = new Talon(RobotMap.TALON_DRIVE_FL);
		this.m_talonFR = new Talon(RobotMap.TALON_DRIVE_FR);
